 ...
 * Generated for Laravel 7.1.3 on 2020-03-18 22:41:48.
 *
...
namespace Modules\Core\BreadCrumbs\Facades { 
    ...
    class Breadcrumbs {
        ...
        {
                        /** @var \Modules\Core\BreadCrumbs\BreadcrumbsManager $instance */
         ...
         * @return \Modules\Core\BreadCrumbs\Collection The generated breadcrumbs.
         ...
         * @param string|null $name The name of the current page.
         * @param mixed $params The parameters to pass to the closure for the current page.
         * @return \Modules\Core\BreadCrumbs\HtmlString The generated HTML.
        ...
        public static function macro($name, $macro)
        {
                        \Modules\Core\BreadCrumbs\BreadcrumbsManager::macro($name, $macro);
        }
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Modules\Core\BreadCrumbs\BreadcrumbsManager::mixin($mixin, $replace);
        }
        ...
        public static function hasMacro($name)
        {
                        return \Modules\Core\BreadCrumbs\BreadcrumbsManager::hasMacro($name);
        }
...
namespace Modules\Core\Flash\Facades { 
    ...
    class Flash {
         ...
         *
         * @param string|null $message
         * @return \Modules\Core\Flash\Notifiers\FlashNotifier 
         * @static 
         */ 
        public static function info($message = null)
        {
                        /** @var \Modules\Core\Flash\Notifiers\FlashNotifier $instance */
        ...
        public static function macro($name, $macro)
        {
                        \Modules\Core\Flash\Notifiers\FlashNotifier::macro($name, $macro);
        }
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Modules\Core\Flash\Notifiers\FlashNotifier::mixin($mixin, $replace);
        }
        ...
        public static function hasMacro($name)
        {
                        return \Modules\Core\Flash\Notifiers\FlashNotifier::hasMacro($name);
        }
...
namespace Modules\Core\Notify\Facades { 
    ...
    class Notify {
        ...
        {
                        /** @var \Modules\Core\Notify\Notify $instance */
...
namespace Modules\Core\Blade_DBCompiler\Facades { 
    ...
    class DbView {
         ...
         *
         * @param \Modules\Core\Blade_DBCompiler\Model $model
         * @param array $data
         * @param array $mergeData
         ...
         * @static 
         */ 
        public static function make($model, $data = [], $mergeData = [], $content_field = null)
        {
                        /** @var \Modules\Core\Blade_DBCompiler\DbView $instance */
                        return $instance->make($model, $data, $mergeData, $content_field);
        }
        ...
        {
                        /** @var \Modules\Core\Blade_DBCompiler\DbView $instance */
                        return $instance->field($content_field);
        }
         ...
         * @param string $view
         * @param array $data
         * @return \Modules\Core\Blade_DBCompiler\PrimaryView 
         * @static 
         */ 
        public static function nest($key, $view, $data = [])
        {
                        /** @var \Modules\Core\Blade_DBCompiler\DbView $instance */
                        return $instance->nest($key, $view, $data);
        }
        ...
        public static function renderSections()
        {
            //Method inherited from \Illuminate\View\View            
                        /** @var \Modules\Core\Blade_DBCompiler\DbView $instance */
                        return $instance->renderSections();
        }
         ...
         * @param string|array $key
         * @param mixed $value
         * @return \Modules\Core\Blade_DBCompiler\DbView 
         * @static 
         */ 
         ...
         * @static 
         */ 
        public static function withErrors($provider, $bag = 'default')
        {
            //Method inherited from \Illuminate\View\View            
                        /** @var \Modules\Core\Blade_DBCompiler\DbView $instance */
                        return $instance->withErrors($provider, $bag);
        }
        ...
        {
            //Method inherited from \Illuminate\View\View            
                        \Modules\Core\Blade_DBCompiler\DbView::macro($name, $macro);
        }
        ...
        {
            //Method inherited from \Illuminate\View\View            
                        \Modules\Core\Blade_DBCompiler\DbView::mixin($mixin, $replace);
        }
        ...
        {
            //Method inherited from \Illuminate\View\View            
                        return \Modules\Core\Blade_DBCompiler\DbView::hasMacro($name);
        }
...
namespace  { 
    ...
    class Breadcrumbs extends \Modules\Core\BreadCrumbs\Facades\Breadcrumbs {}

    class Flash extends \Modules\Core\Flash\Facades\Flash {}

    class Notify extends \Modules\Core\Notify\Facades\Notify {}

    class DbView extends \Modules\Core\Blade_DBCompiler\Facades\DbView {}
