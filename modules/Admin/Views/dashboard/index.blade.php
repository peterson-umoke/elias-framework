...
@section("page_breadcrumbs", Breadcrumbs::render('admin.home'))
@section('content')
    <div class="ecommerce-widget">
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card border-3 border-top border-top-primary">
                    ...
                    <div class="card-body">
                        <h2>Hello, {{auth("admin")->user()->first_name}}</h2>
                        <p>Here are some quick actions to get you started.</p>

                        <div class="row">
                            @each('admin::dashboard.partials.quick-actions-container', config("admin.dashboard.quick_action_menus"), 'item')
                        </div>
                    </div>
                </div>
            </div>
        ...
        @each('admin::dashboard.partials.widgets-container', config("admin.dashboard.widgets"), 'item')
