...
@section("page_breadcrumbs",Breadcrumbs::render("admin.roles.index", $title))
@section("content")
    <div class="row">
        <!-- ============================================================== -->
        <!-- basic table  -->
                ...
                <h5 class="card-header">
                    <div class="float-left">
                        ...
                        @if(current_admin()->can("delete-acl"))
                            <a id="bulkDeleteBtn" href="{{route("admin.roles.create")}}" class="btn btn-danger"><i
                        ...
                        <table id="dataThings" class="table table-striped table-bordered initDatatables">
                                ...
                                <th>
                                    <label class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                               id="selectAllTop" value="Check All"><span
                            ...
                            @foreach($datas as $data)
                                <tr>
                                    ...
                                    <td style="width: 17%;">
                                        {!! Form::open(["route" => ["admin.roles.destroy", "role" => $data->id],"method" => "delete"]) !!}
                                        @if(current_admin()->can("update-acl"))
                                            <a href="{{route("admin.roles.edit", ["role" => $data->id])}}"
                                               class="btn btn-success btn-sm"><i
                                                    class="fas fa-edit fa-fw"></i></a>
                                        @endif
                                        @if(current_admin()->can("read-acl"))
                                            <a href="{{route("admin.roles.show",["role" => $data->id])}}"
