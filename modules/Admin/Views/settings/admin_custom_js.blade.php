<div class="row">
    <div class="col">
        <div class="form-group">
            {!! Form::textarea('admin_custom_js', $settings->get_setting_value("admin_custom_js", $channel), ['class' => 'form-control',"placeholder" =>
            "Write customized JS Code blocks here", "style" => "height:300px;","id" => "admin_custom_js"]) !!}
            @error('admin_custom_js')
        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul style="margin-left:0; padding-left: 10px;">
                    ...
                    <li><small>Remember to insert the script tag before inserting any javascript code, else it wont
                            work!!!</small>
                    </li>
                </ul>
            </div>
    ...
    <script>
        (function ($) {
            $(document).ready(function () {
                var codeEditor = $("#admin_custom_js")[0];
                var editor = CodeMirror.fromTextArea(codeEditor, {
                    ...
                    placeholder: '/** always start your code with <script /> tag */',
                    lineNumbers: true,
                    indentUnit: 2,
                    smartIndent: true,
                    autoCloseTags: true,
