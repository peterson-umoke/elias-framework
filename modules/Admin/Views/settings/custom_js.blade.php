<div class="row">
    <div class="col">
        <div class="form-group">
            {!! Form::textarea('custom_js', $settings->get_setting_value("custom_js", $channel), ['class' => 'form-control',"placeholder" =>
            "Write customized JS Code blocks here", "style" => "height:300px;","id" => "custom_js"]) !!}
            @error('custom_js')
