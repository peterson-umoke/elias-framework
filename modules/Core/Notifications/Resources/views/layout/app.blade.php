...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('modules/Core/Notifications/Assets/css/app.css') }}">
    @notifications_css
...
@include('notifications::layout.header')

<div class="container mt-5">

    @yield('content')

    @include('notifications::layout.footer')
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="{{ asset('modules/Core/Notifications/Assets/js/app.js') }}"></script>
