...
@section('content')
    ...
    <div class="row mb-5">
        <div class="col-md-7">
            <div class="card align-items-center">
                <div class="card-body">
                    <div class="connectify-alert connectify-success {{ config('notifications.theme') }}" role="alert">
                    ...
                    <div class="connectify-alert connectify-error {{ config('notifications.theme') }}" role="alert">
                        <div class="connectify-icon">
    ...
    <div class="row mb-5">
        <div class="col-md-7">
            <div class="card align-items-center">
                <div class="card-body">
                    <div class="notify-alert notify-success {{ config('notifications.theme') }}" role="alert">
                    ...
                    <div class="notify-alert notify-info {{ config('notifications.theme') }}" role="alert">
                    ...
                    <div class="notify-alert notify-warning {{ config('notifications.theme') }}" role="alert">
                    ...
                    <div class="notify-alert notify-error {{ config('notifications.theme') }}" role="alert">
        ...
        <div class="col-md-5">
            <h4># Basic Usage</h4>
            <p>From your application, call the flash method with a message and type.</p>
            <pre><code class="language-php">notification()->success('You have successfully logged in');</code></pre>
            <pre><code class="language-php">notification()->info('You have new subscribers');</code></pre>
            <pre><code class="language-php">notification()->warning('Please charge your mobile phone');</code></pre>
            <pre><code class="language-php">notification()->error('Some error here please try again');</code></pre>
        </div>
    </div>
    ...
    <div class="row mb-5">
        <div class="col-md-7">
            <div class="card align-items-center">
                <div class="card-body">
                    <div class="smiley-alert smiley-success {{ config('notifications.theme') }}" role="alert">
                    ...
                    <div class="smiley-alert smiley-error {{ config('notifications.theme') }}" role="alert">
                        <div class="smiley-icon"><span>🙅🏽‍♂️</span></div>
                        <div class="smiley-text">
                            <p><span class="title">Error!</span>, it seems your file is too big, try reducing the file
