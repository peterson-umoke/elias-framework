...
@section('content')
    ...
    @include("page::admin.buttons", ["btnTitle" => "Create Page"])

    <div class="row">
        <div class="col">
            <div class="form-group row">
                <div class="col">
                    {!! Form::text('title',null, ["placeholder" => "Enter the title", "style" => "font-size: 1.5em;", 'class' => 'p-2 form-control'])!!}
                    @error('title')
            ...
            <div class="form-group row">
                <div class="col">
                    {!! Form::text('route',null, ["placeholder" => "Enter the Page Route", 'class' => 'form-control'])!!}
                    @error('route')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
    ...
    <div class="row">
        <div class="col">
            <div class="form-group row">
                <div class="col">
                    {!! Form::textarea('pcontent',null,["id" => "pcontent", "placeholder" => "Enter the content", 'class' => 'form-control'])!!}
                    @error('pcontent')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col">
                            {!! Form::text('seo_content',null, ['class' => 'form-control'])!!}
                            @error('seo_content')
                            <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
