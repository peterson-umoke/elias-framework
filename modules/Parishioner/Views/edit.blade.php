...
@section("page_breadcrumbs",Breadcrumbs::render("admin.parishioners.edit", $title, $parishioner->id))

@section('content')
    {!! Form::open(['route' => ['admin.parishioners.update', $parishioner->id], 'method' => 'put',"files" => true]) !!}

    <div class="">
        <div class="float-right">
            <img class="img-fluid img-thumbnail" style="width: 150px; height: 150px;" src="{{admin_uploads(get_setting('admin_favicon','all'))}}">
        </div>
    </div>
        ...
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade active show" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                    ...
                    <div class="col-2">
                        <div class="form-group row">
                            <div class="col">
                                ...
                                {!! Form::select('title', ["Chief" => "Chief","Mr" => "Mr","Mrs" => "Mrs","Master" => "Master","Mistress" => "Mistress","Madam" => "Madam","Don" => "Don","Pastor" => "Pastor","Dr" => "Dr","Engr" => "Engr","Father" => "Father"],$parishioner->title, ['class' => 'form-control'])!!}
                                @error('title')
                    ...
                    <div class="col">
                        <div class="form-group row">
                            <div class="col">
                                ...
                                {!! Form::text('surname',$parishioner->surname, ["placeholder" => "Surname", "style" => "", 'class' => 'p-2 form-control'])!!}
                                @error('surname')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col">
                        <div class="form-group row">
                            <div class="col">
                                ...
                                {!! Form::text('first_name',$parishioner->first_name, ["placeholder" => "First Name", "style" => "", 'class' => 'p-2 form-control'])!!}
                                @error('first_name')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col">
                        <div class="form-group row">
                            <div class="col">
                                ...
                                {!! Form::text('last_name',$parishioner->last_name, ["placeholder" => "Last Name", "style" => "", 'class' => 'p-2 form-control'])!!}
                                @error('last_name')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::text('telephone_number', $parishioner->telephone_number, ['class' => 'form-control'])!!}
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::select('gender', ["male" => "Male", "female" => "Female"],$parishioner->gender, ['class' => 'form-control'])!!}
                                @error('gender')
                                <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::select('marital_status', ["married" => "Married", "single" => "Single"],$parishioner->marital_status, ['class' => 'form-control'])!!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col">
                        {!! Form::date('date_of_birth', $parishioner->date_of_birth ?? \Carbon\Carbon::now(), ['class' => 'form-control',"type" => "date"])!!}
                        @error('date_of_birth')
                        <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::text('state', $parishioner->state, ['class' => 'form-control'])!!}
                                @error('state')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::text('town', $parishioner->town, ['class' => 'form-control'])!!}
                                @error('town')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::text('village', $parishioner->village, ['class' => 'form-control'])!!}
                                @error('village')
                                <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::select('parishioner_status', ["Employed" => "Employed", "Unemployed" => "Unemployed", "Student" => "Student", "Dependent" => "Dependent"],$parishioner->parishioner_status, ['class' => 'form-control'])!!}
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::text('occupation', $parishioner->occupation, ['class' => 'form-control'])!!}
                                @error('occupation')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    @php $fieldNe = "are_you_" . $field; @endphp
                                    {!! Form::select('are_you_' . $field, [ "Yes" => "Yes","No" => "No"],$parishioner->$fieldNe, ['class' => 'form-control'])!!}
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    @php $fieldNewName = $field . "_parish_name"; @endphp
                                    {!! Form::text($field . '_parish_name', $parishioner->$fieldNewName, ['class' => 'form-control'])!!}
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    @php $fieldNew = $field . "_parish_state_town"; @endphp
                                    {!! Form::text($field . '_parish_state_town', $parishioner->$fieldNew, ['class' => 'form-control'])!!}
                        ...
                        <div class="col">
                            <div class="form-group row">
                                ...
                                <div class="col">
                                    @php $fieldNewDate = $field . "_date"; @endphp
                                    {!! Form::date($field . '_date', $parishioner->$fieldNewDate ?? \Carbon\Carbon::now(), ['class' => 'form-control'])!!}
                                    @error($field . '_date')
                                    <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
            ...
            <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::select('statutory_organization',["C.M.O" => "C.M.O", "C.W.O" => "C.W.O", "C.Y.O.N" => "C.Y.O.N", "None" => "None"],$parishioner->statutory_organization, ['class' => 'form-control'])!!}
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::select('are_you_society_member',[ "Yes" => "Yes","No" => "No"],$parishioner->are_you_society_member, ['class' => 'form-control'])!!}
                ...
                @for($i = 1; $i<= 5; $i++)
                    <div class="form-group row">
                        <div class="col">
                            {!! Form::text('organisation_' . $i,$parishioner->organisation_.$i, ['class' => 'form-control', "placeholder" => "Enter Name Of Organisation"])!!}
                ...
                <div class="row">
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::text('sunday_mass_attend',$parishioner->sunday_mass_attend, ['class' => 'form-control'])!!}
                    ...
                    <div class="col">
                        <div class="form-group row">
                            ...
                            <div class="col">
                                {!! Form::text('registration_number',$parishioner->registration_number, ['class' => 'form-control'])!!}
    ...
    @include("parishioner::buttons",["btnTitle" => "Update Parishioner"])
    {!! Form::close() !!}
@endsection
